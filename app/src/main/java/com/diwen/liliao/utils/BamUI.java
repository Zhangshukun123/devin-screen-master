...
public class BamUI {
     ...
     * 变速器
     */
    public static OvershootInterpolator interpolator = new OvershootInterpolator(1f);

    /**
     * 缩放比例
     */
    private static final float SCALE_END = 0.97f;
     ...
     * 【缩放效果】从大过渡到小
     */
    public static void froBig_ToSmall(View view,float END) {
        try {
            float tzStart = 0;
            Object viewTag = view.getTag(R.string.view_tag_key);
            if (android.os.Build.VERSION.SDK_INT >= 21) {
             ...
             * 控件的宽变小
             */
            PropertyValuesHolder sx = PropertyValuesHolder.ofFloat("scaleX", view.getScaleX(), END);
            /**
             * 控件的高变小
             */
            PropertyValuesHolder sy = PropertyValuesHolder.ofFloat("scaleY", view.getScaleY(), END);
